...
namespace Biometric_Verification_System.Migrations
{
    public partial class injhuyt : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FingerprintData", x => x.FingerprintId);
                    table.ForeignKey(
                        name: "FK_FingerprintData_AspNetUsers_Id",
                        column: x => x.Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
